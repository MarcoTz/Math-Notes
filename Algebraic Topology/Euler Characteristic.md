For $2$-dimensional CW complexes $X$ (i.e. [[Graph]]s considered as $0$-cells vertices, $1$-cells edges and $2$-cells faces), the *Euler Characteristic* $\chi(X)$ of $X$ is defined as 
