Let $S$ be a [[Gradings]] and $X=ProjS$ ([[Projective Scheme]]). Then for $n\in \mathbb{Z}$, the *twisting sheaf of Serre*, $\mathcal{O}_X(n)$ is the [[Sheaf]]  $S(n)\tilde{}$ (elements of $S$  with degree at least $n$ and valuation of $S$ -n). 
